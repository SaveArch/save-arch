...
const heritageMarkers: HeritageMarker[] = [
  ...
  {
    id: '6',
    coordinates: [12.491970, 41.890393], // Колизей
    type: 'monitoring',
    title: 'Колизей',
    description: 'Колизей — крупнейший амфитеатр Древнего Рима, символ архитектурного мастерства и культуры античного общества.',
    details: 'Колизей вмещал до 50 000–80 000 зрителей. Построен из туфа, бетона и кирпича. Имеет овальную форму, три яруса арок и подземные помещения для гладиаторов и животных',
    historicalInfo: 'Строительство завершено в 80 году н. э. при императоре Тите. Использовался для гладиаторских боёв, публичных представлений и императорских зрелищ. Со временем пострадал от землетрясений и разрушений, но частично сохранился до наших дней.',
    date: 'Мониторинг с: октябрь 2025',
  ...
  {
    id: '10',
    coordinates: [115.877030, 41.209878], // Великая Китайская стена
    type: 'digitized',
    title: 'Великая Китайская стена',
    description: 'Великая Китайская стена — грандиозное оборонительное сооружение в Китае, символ исторической мощи и защиты государства.',
    details: 'Стена протянулась более 21 000 километров, включая все её ветви. Построена из камня, кирпича и утрамбованной земли. Имеет башни и фортификационные укрепления для наблюдения и обороны.',
    historicalInfo: 'Строительство началось ещё в VII веке до н. э., но основная часть стены, которую мы видим сегодня, возведена при династии Мин (1368–1644 гг.). Стена использовалась для защиты от кочевых племён и символизировала мощь империи.',
    date: 'Мониторинг с: октябрь 2025',
    status: 'Стабильный',
  },
];
