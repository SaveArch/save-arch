...
const heritageMarkers: HeritageMarker[] = [
  ...
  {
    id: '2',
    coordinates: [51.9141, 47.1044], // Успенский собор
    type: 'monitoring',
    title: 'Успенский кафедральный собор',
    description: 'Православный храм, построенный в 1888 году. Памятник архитектуры.',
    details: 'Редкий образец каменного зодчества старого Гурьева, сохранившийся через советский период. Ведётся мониторинг состояния фундамента и стен. Кирпичная кладка требует реставрации швов.',
    historicalInfo: 'Храм был закрыт в 1930-е годы и использовался как склад. Возвращён Русской православной церкви в 1991 году. Является объектом культурного наследия местного значения.',
