...
const heritageMarkers: HeritageMarker[] = [
  ...
  {
    id: '11',
    coordinates: [68.270918, 43.297749], // Мавзолей Ходжи Ахмеда-Ясауи
    type: 'digitized',
    title: 'Мавзолей Ходжи Ахмеда-Ясауи',
    description: 'Мавзолей Ходжи Ахмеда-Ясауи — крупный архитектурный и религиозный памятник в Туркестане, Казахстан, символ духовного наследия и исламской культуры региона.',
    details: 'Мавзолей построен из кирпича и камня, имеет купол диаметром около 17 метров. Включает внутренние помещения для поклонения, гробницу святого, арки и резные декоративные элементы. Архитектурный стиль — туркестанская архитектура с элементами тюркской и исламской традиции.',
    historicalInfo: 'Строительство начато при Тимуридах в XIV веке по приказу Тимура (Тамерлана). Мавзолей является мемориальным и культовым объектом, а с 2003 года включён в Список Всемирного наследия ЮНЕСКО.',
    date: 'Мониторинг с: октябрь 2025',
    status: 'Стабильный',
  },
  {
    id: '12',
    coordinates: [-114.73246, 33.59730], // Меса-Верде
    type: 'digitized',
    title: 'Меса-Верде',
    description: 'Меса-Верде — национальный парк в США с хорошо сохранившимися древними поселениями индейцев анасази, вырезанными в скалах.',
    details: 'Комплекс включает более 600 скальных жилищ и оборонительных сооружений, построенных в нишах утёсов. Жилища состояли из комнат для жилья, хранения и ритуалов. Археологические находки включают керамику, инструменты и рисунки на стенах.',
    historicalInfo: 'Поселения датируются около 600–1300 годов н. э. и были населены народом анасази (предки пуэбло). Они были заброшены по неизвестным причинам, возможно из-за засухи или истощения ресурсов. В 1978 году Меса-Верде включена в Список Всемирного наследия ЮНЕСКО.',
    date: 'Мониторинг с: октябрь 2025',
    status: 'Под наблюдением',
  },
];
